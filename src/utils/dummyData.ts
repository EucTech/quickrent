...
export const PropertyData: PropertyPropsType[] = [
  ...
  {
    listingType: "Rent",
    title: "Charming Apartment in Barcelona",
    price: "2,800",
    numOfBeds: "2",
    numOfBaths: "1",
    propertyMeter: "100 ",
...
export const FeaturedData: FeaturedPropsType[] = [
  ...
  {
    listingType: "Rent",
    title: "Stylish Studio in London",
    price: "2,800",
    numOfBeds: "1",
    numOfBaths: "1",
    propertyMeter: "60 ",
  ...
  {
    listingType: "Sale",
    title: "Beautiful Farmhouse in Napa Valley",
    price: "3,200,000",
    numOfBeds: "4",
    numOfBaths: "3",
    propertyMeter: "500 ",
